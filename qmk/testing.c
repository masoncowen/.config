...
[_ALPHA] = LAYOUT_planck_grid(
  KC_Y , KC_C , KC_L , KC_M , KC_K , KC_NO , KC_NO , KC_Z , KC_F , KC_U , KC_COMM , KC_SCLN ,
  KC_I , KC_S , KC_R , KC_T , KC_G , KC_NO , KC_NO , KC_P , KC_N , KC_E , KC_A , KC_O ,
  KC_Q , KC_V , KC_W , KC_D , KC_J , KC_NO , KC_NO , KC_B , KC_H , CC_RPEAT , KC_DOT , KC_X ,
  KC_NO , KC_NO , KC_NO , OSM(MOD_LCTL) , KC_SPC , KC_NO , KC_NO , OSL(_NUMNAV) , OSM(MOD_LSFT) , KC_NO , KC_NO , KC_NO
),
...
[_NUMNAV] = LAYOUT_planck_grid(
  ...
  KC_NO   , KC_NO , KC_NO , OSM(MOD_LCTL) , KC_DEL , KC_NO , KC_NO , KC_BSPC , OSM(MOD_LSFT) , KC_NO , KC_NO , KC_NO
)
};
