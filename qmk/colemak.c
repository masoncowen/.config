...
[_ALPHA] = LAYOUT_planck_grid(
  ...
  KC_NO , KC_NO , KC_NO , KC_SPC , OSL(_NUMNAV) , KC_NO , KC_NO , OSM(MOD_LCTL) , OSM(MOD_LSFT) , KC_NO , KC_NO , KC_NO
),
...
[_NUMNAV] = LAYOUT_planck_grid(
  ...
  KC_NO   , KC_NO , KC_NO , KC_BSPC , KC_DEL , KC_NO , KC_NO , OSM(MOD_LCTL) , OSM(MOD_LSFT) , KC_NO , KC_NO , KC_NO
)
};
